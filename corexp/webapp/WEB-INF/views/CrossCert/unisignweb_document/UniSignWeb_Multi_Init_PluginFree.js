...
var unisign = UnisignWeb({
    ...
    /* // TODO : ?�?�매�?추�????�정?�야??부�?*/
    Media: {'defaultdevice':'webstorage', 'list':'webstorage|touchsign|smartsign|websectoken|websofttoken'},/* plugin-free mode(Mode:2) media list */ // sharestorage|   cloudsign
    ...
    LimitMinNewPWLen: 8,
    LimitMaxNewPWLen: 64,
    LimitNewPWPattern: 0,  //0 : ?�한 ?�음, 1 : ?�문,?�자 ?�합, 2 : ?�문,?�자,?�수문자 ?�합
