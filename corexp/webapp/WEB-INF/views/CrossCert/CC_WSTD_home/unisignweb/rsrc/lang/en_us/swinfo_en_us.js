(function() {
    return {
        IDS_SW_INFO:                        "Software infomations",
        IDS_SW_INFO_CLOSE:                  "Close this window",
        IDS_CONFIRM:                        "Close",
        IDS_BUTTON:                         "Button",
        IDS_SW_NAME:                        "CrossCertWeb",
        IDS_COPY_RIGHT:                     "Copyrightⓒ 2014 CrossCert. All rights reserved.",
