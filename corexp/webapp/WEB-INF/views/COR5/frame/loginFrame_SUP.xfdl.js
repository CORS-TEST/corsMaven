(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_ID\" size=\"256\" type=\"STRING\"/><Column id=\"USER_PW_ORG\" size=\"256\" type=\"STRING\"/><Column id=\"USER_PW_ENCODE\" size=\"256\" type=\"STRING\"/><Column id=\"ALT_COOKIE\" size=\"256\" type=\"STRING\"/><Column id=\"LANG_CD\" size=\"256\" type=\"STRING\"/><Column id=\"AD_ID\" size=\"256\" type=\"STRING\"/></ColumnInfo>");
            ...
            obj = new Div("divViewCompTitle00", "absolute", "10", "20", "230", "24", null, null, this);
            obj.getSetter("objNm").set("DIV-평가서 타이틀");
            obj.set_taborder("3");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            obj = new Static("staViewCompTitle00", "absolute", "0", "0", "220", "24", null, null, this.divViewCompTitle00);
            obj.set_cssclass("sta_WF_Subtitle");
            obj.set_taborder("0");
            obj.set_text("내부사용자");
            this.divViewCompTitle00.addChild(obj.name, obj);

            obj = new Div("divViewCompBody00", "absolute", "10", "54", "230", "362", null, null, this);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            obj = new Grid("grdDevUserInfo", "absolute", "0", "0", null, null, "0", "0", this.divViewCompBody00);
            obj.set_autofittype("col");
            obj.set_binddataset("dsDevUserInfo");
            obj.set_taborder("0");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"125\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"사용자명\"/><Cell col=\"1\" text=\"사용자권한\"/></Band><Band id=\"body\"><Cell text=\"bind:USER_NM\"/><Cell col=\"1\" text=\"bind:ROLE_NM\"/></Band></Format></Formats>");
            this.divViewCompBody00.addChild(obj.name, obj);

            obj = new Div("divViewCompTitle01", "absolute", "10", "450", "230", "24", null, null, this);
            obj.getSetter("objNm").set("DIV-평가서 타이틀");
            obj.set_taborder("5");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divViewCompBody01", "absolute", "10", "494", "230", "362", null, null, this);
            obj.set_taborder("6");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            obj = new Grid("grdPtnrUserInfo", "absolute", "0", "0", null, null, "0", "0", this.divViewCompBody01);
            obj.set_autofittype("col");
            obj.set_binddataset("dsPtnrUserInfo");
            obj.set_taborder("0");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"125\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"사업자번호\"/><Cell col=\"1\" text=\"협력사명\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" mask=\"###-##-#####\" maskchar=\" \" text=\"bind:BIZ_NO\"/><Cell col=\"1\" style=\"align: ;\" text=\"bind:PTNR_NM\"/></Band></Format></Formats>");
            this.divViewCompBody01.addChild(obj.name, obj);

            obj = new Div("divViewCompTitle02", "absolute", null, "20", "320", "24", "10", null, this);
            obj.getSetter("objNm").set("DIV-평가서 타이틀");
            obj.set_taborder("7");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Div("divViewCompBody02", "absolute", null, "54", "320", "338", "10", null, this);
            obj.set_taborder("8");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Div("divCenter", "absolute", "25.78%", "114", "488", "294", null, null, this);
            ...
            this.divCenter.addChild(obj.name, obj);
            obj = new Static("staCopyright", "absolute", "32", "272", "444", "21", null, null, this.divCenter);
            obj.getSetter("objNm").set("");
            obj.set_taborder("111");
            obj.set_text("Copyright  HUMAX OPEN PURCHASING E-System Co., Ltd. All rights reserved.");
            this.divCenter.addChild(obj.name, obj);
            obj = new ImageViewer("imvLogo", "absolute", "6.56%", "30", "444", "80", null, null, this.divCenter);
            obj.set_image("URL('theme://images/Home_Hope.png')");
            ...
            obj = new Combo("Combo00", "absolute", "109", "23", "130", "24", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_codecolumn("CD_ID");
            obj.set_datacolumn("CD_NM_LO");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 230, 362, this.divViewCompBody00,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("4");
            		p.set_visible("false");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 230, 362, this.divViewCompBody01,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("6");
            		p.set_visible("false");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 320, 338, this.divViewCompBody02,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("8");
            		p.set_visible("false");
        ...
        // User Script
        this.registerScript("loginFrame_SUP.xfdl", function(exports) {
        /**
         * @파일명       	: loginFrame.xfdl
         * @생성자       	: 한민희
         * @생성일자     	: 2017.11.07.
        ...
        */ 
        ...
        this.fnOnLoad = function(obj,e)
        {
        	...
        	this.labelVer = application.gdsLabel.getConstColumn("VERSION");
        ...
        this.fnGdsFileRead = function(){
        	...
        	if(gfnIsNull(labelXml)||gfnIsNull(cdXml)){
        		...
        		this.dsLabel.loadXML(nexacro.stripQuote(nexacro.replaceAll(labelXml,"&quot;","'")));
        		this.dsCommCd.loadXML(nexacro.stripQuote(nexacro.replaceAll(cdXml,"&quot;","'")));		
        		var dsLV = this.dsLabel.getConstColumn("VERSION");
        		var dsCV = this.dsCommCd.getConstColumn("VERSION");
        		
        		var gdsLV = application.gdsLabel.getConstColumn("VERSION");
        		var gdsCV =  application.gdsCommCd.getConstColumn("VERSION");
        		if(gfnIsNull(dsLV)||gfnIsNull(dsCV)||gfnIsNull(gdsLV)||gfnIsNull(gdsCV)||
        			(dsLV!=gdsLV)||(dsCV!=gdsCV)
        			){
        			return false;
        		}else{
        			return true;
        ...
        this.fnGdsFileWrite = function(){
        	this.dsLabel.addConstColumn("VERSION");
        	this.dsCommCd.addConstColumn("VERSION");
        	this.dsLabel.setConstColumn("VERSION",this.labelVer);
        	this.dsCommCd.setConstColumn("VERSION",this.cdVer);
        	var rtnLabel = application.setPrivateProfile("_gdsLabel", nexacro.wrapQuote(this.dsLabel.saveXML()));
        	var rtnCd = application.setPrivateProfile("_gdsCommCd", nexacro.wrapQuote(this.dsCommCd.saveXML()));
        }
        ...
        {	
        	var sArg = {};
        	gfnModalPop(this, "SPtnrReq", "CPOP::SPtnrReq.xfdl", sArg, "fnPopCallBack", 405, 190);
        }
        ...
        /**
        	@function	fnCboSlOnChange()
        	@desc   	유저 필터
        */
        this.fnCboSlOnChange = function(obj,e)
        {
        	if(e.postvalue==""){
        		this.dsPurUserInfo.filter("");
        	}else{
        		this.dsPurUserInfo.filter("SL_NM=='"+e.postvalue+"'");
        	}
        }

        this.divCenter_edtId_oneditclick = function(obj,e)
        {
        /*
        	this.divViewCompTitle00.set_visible(true);
        	this.divViewCompBody00.set_visible(true);
        	
        	this.divViewCompTitle01.set_visible(true);
        	this.divViewCompBody01.set_visible(true);
        	
        	this.divViewCompTitle02.set_visible(true);
        ...
        */	
        ...
        this.loginFrame_onclick = function(obj,e)
        {
        	this.divViewCompTitle00.set_visible(false);
        	this.divViewCompBody00.set_visible(false);
        	
        	this.divViewCompTitle01.set_visible(false);
        	this.divViewCompBody01.set_visible(false);
        	
        	this.divViewCompTitle02.set_visible(false);
        ...
        this.Combo00_onitemchanged = function(obj,e)
        {
        	if(!gfnIsNull(obj.value)){
        		this.dsDevUserInfo.set_enableevent(false);
        		this.dsDevUserInfo.filter("ALT_TEAM =='"+obj.value+"'")
        		this.dsDevUserInfo.set_enableevent(true);
        	}else{
        		this.dsDevUserInfo.filter("")
        	}
        }

        /**
        	@function	grdDevUserInfo_oncellclick()
        	@desc   	사용자아이디세팅(임시)
        */
        this.grdDevUserInfo_oncellclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_PW_ORG")));
        }

        /**
        	@function	grdDevUserInfo_oncelldblclick()
        	@desc   	사용자 그리드더블클릭시 로그인(임시)
        */
        this.grdDevUserInfo_oncelldblclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsDevUserInfo.getColumn(this.dsDevUserInfo.rowposition, "USER_PW_ORG")));
        ...
        /**
        	@function	grdPtnrUserInfo_oncellclick()
        	@desc   	협력사아이디세팅(임시)
        */
        this.grdPtnrUserInfo_oncellclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_PW_ORG")));
        }

        /**
        	@function	grdPtnrUserInfo_oncelldblclick()
        	@desc   	협력사 그리드더블클릭시 로그인(임시)
        */
        this.grdPtnrUserInfo_oncelldblclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsPtnrUserInfo.getColumn(this.dsPtnrUserInfo.rowposition, "USER_PW_ORG")));
        ...
        /**
        	@function	grdPurUserInfo_oncellclick()
        	@desc   	구매자 그리드더블클릭시 로그인(임시)
        */
        this.grdPurUserInfo_oncellclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_PW_ORG")));
        }

        /**
        	@function	grdPurUserInfo_oncelldblclick()
        	@desc   	구매자 그리드더블클릭시 로그인(임시)
        */
        this.grdPurUserInfo_oncelldblclick = function(obj,e)
        {
        	this.dsUser.setColumn(0,"USER_ID", this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_ID"));
        	this.dsUser.setColumn(0,"USER_PW_ORG", this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_PW_ORG"));
        	this.dsUser.setColumn(0,"USER_PW_ENCODE", gfnEncode(this.dsPurUserInfo.getColumn(this.dsPurUserInfo.rowposition, "USER_PW_ORG")));
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompBody00.grdDevUserInfo.addEventHandler("oncellclick", this.grdDevUserInfo_oncellclick, this);
            this.divViewCompBody00.grdDevUserInfo.addEventHandler("oncelldblclick", this.grdDevUserInfo_oncelldblclick, this);
            this.divViewCompTitle01.staViewCompTitle00.addEventHandler("onclick", this.div_2_staSubTitle01_onclick, this);
            this.divViewCompBody01.grdPtnrUserInfo.addEventHandler("oncellclick", this.grdPtnrUserInfo_oncellclick, this);
            this.divViewCompBody01.grdPtnrUserInfo.addEventHandler("oncelldblclick", this.grdPtnrUserInfo_oncelldblclick, this);
            this.divCenter.edtId.addEventHandler("oneditclick", this.divCenter_edtId_oneditclick, this);
        ...
        this.loadIncludeScript("loginFrame_SUP.xfdl", true);
