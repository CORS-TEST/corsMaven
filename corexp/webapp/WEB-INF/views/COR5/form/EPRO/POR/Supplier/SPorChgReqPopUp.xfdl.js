    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("SPorChgReq");
                this.set_titletext("변경요청 사유");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CNCL_RSN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Button("btnRtn", "absolute", null, "11", "45", "24", "10", null, this);
            obj.set_taborder("6");
            obj.set_text("확인");
        ...
        // User Script
        this.registerScript("SPorChgReqPopUp.xfdl", function(exports) {
        /**
        ...
        */
        ...
        /**
          ...
          * @desc		: 적용
          */ 
        this.btnRtn_onclick = function(obj,e)
        {
        ...
        {
            this.btnRtn.addEventHandler("onclick", this.btnRtn_onclick, this);

        };

        this.loadIncludeScript("SPorChgReqPopUp.xfdl", true);
