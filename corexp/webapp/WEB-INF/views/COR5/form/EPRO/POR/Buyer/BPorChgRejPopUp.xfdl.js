    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("BPorRejChgReqPopUp");
                this.set_titletext("변경요청거부  사유");
        ...
        // User Script
        this.registerScript("BPorChgRejPopUp.xfdl", function(exports) {
        /**
           @file       BPorChgRejPopUp
        ...
        */
        ...
        this.btnCnfrm_onclick = function(obj,e)
        {
        	...
        	if(!gfnConfirm("발주번호 ["+this.dsRtn.getColumn(0,"PO_NO_ARR")+"]를 변경요청 거부 하시겠습니까?")) return;
        ...
        this.loadIncludeScript("BPorChgRejPopUp.xfdl", true);
