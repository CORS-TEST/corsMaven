(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"FILE_NM\" size=\"256\" type=\"STRING\"/><Column id=\"CHECKED\" size=\"256\" type=\"STRING\"/><Column id=\"NO\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"FILE_NM\">첨부파일</Col><Col id=\"CHECKED\">1</Col><Col id=\"NO\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Tab("Tab00", "absolute", "0", "8", null, "1795", "15", null, this);
            obj.set_taborder("0");
            obj.set_tabindex("0");
            ...
            obj = new Static("Static06", "absolute", "26.74%", "0", "170", "24", null, null, this.Tab00.tabpage1.divViewCompTitle00);
            obj.set_taborder("1");
            obj.set_text("헤더라벨 높이사이즈 24px");
            ...
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0.17%", "65", "170", "33", null, null, this.Tab00.tabpage1.divViewCompBody00);
            obj.set_taborder("290");
            obj.set_text("바디라벨 사이즈 170 x 33");
            obj.set_visible("false");
            obj.style.set_background("aqua");
            obj.style.set_color("red");
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "52.37%", "1", "170", "33", null, null, this.Tab00.tabpage1.divViewCompBody00);
            obj.set_taborder("291");
            obj.set_text("left 629px 에 사이즈 170 x 33");
            obj.set_visible("false");
            obj.style.set_background("aqua");
            obj.style.set_color("red");
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static07", "absolute", "14.21%", "102", "5", "24", null, null, this.Tab00.tabpage1.divViewCompBody00);
            ...
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static08", "absolute", "15.46%", "101", null, "32", "75.73%", null, this.Tab00.tabpage1.divViewCompBody00);
            obj.set_taborder("293");
            obj.set_text("<-간격5픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "28.43%", "165", "5", "24", null, null, this.Tab00.tabpage1.divViewCompBody00);
            ...
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "29.68%", "164", null, "32", "61.51%", null, this.Tab00.tabpage1.divViewCompBody00);
            obj.set_taborder("295");
            obj.set_text("<-간격5픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "20.03%", "29", "211", "5", null, null, this.Tab00.tabpage1.divViewCompBody00);
            ...
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static06", "absolute", "39.15%", "17", null, "32", "51.95%", null, this.Tab00.tabpage1.divViewCompBody00);
            obj.set_taborder("298");
            obj.set_text("<-간격5픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            this.Tab00.tabpage1.divViewCompBody00.addChild(obj.name, obj);
            obj = new Static("Static09", "absolute", "20.03%", "1", "211", "4", null, null, this.Tab00.tabpage1.divViewCompBody00);
            ...
            obj = new Static("Static07", "absolute", "18.54%", "-7", null, "32", "72.57%", null, this.Tab00.tabpage1);
            obj.set_taborder("52");
            obj.set_text("<-간격5픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            this.Tab00.tabpage1.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "0.08%", "30", "211", "5", null, null, this.Tab00.tabpage1);
            obj.set_taborder("53");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("coral");
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "19.2%", "350", null, "32", "71.9%", null, this.Tab00.tabpage1);
            obj.set_taborder("54");
            obj.set_text("<-간격20픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            this.Tab00.tabpage1.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0.08%", "356", "211", "20", null, null, this.Tab00.tabpage1);
            obj.set_taborder("55");
            obj.set_text("20");
            obj.set_visible("false");
            obj.style.set_background("coral");
            obj.style.set_align("center middle");
            this.Tab00.tabpage1.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "0.08%", "0", "211", "5", null, null, this.Tab00.tabpage1);
            obj.set_taborder("56");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("coral");
            ...
            obj = new Static("Static04", "absolute", "39.18%", "60", null, "32", "51.97%", null, this);
            obj.set_taborder("2");
            obj.set_text("<-간격4픽셀");
            obj.set_visible("false");
            obj.style.set_color("red");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("LabelLang15","Tab00.tabpage1.divViewCompBody00.staEval","text","gdsLabel","");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("tabpage5Vi","Tab00.tabpage6","visible","dsObjBindVi","tabpage5");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("tabpage5En","Tab00.tabpage6","enable","dsObjBindEn","tabpage5");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("Detail.xfdl", function(exports) {
        /**
        ...
        */  
        ...
        /**
          ...
          * @desc     	: 폼 oninit이벤트
          */
        this.fnFormOninit = function(Form,e)
        {
        //	this.fnSetCode();
        }
        ...
        */
        ...
        this.loadIncludeScript("Detail.xfdl", true);
