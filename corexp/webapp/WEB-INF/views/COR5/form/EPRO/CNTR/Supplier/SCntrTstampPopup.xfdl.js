(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CNTR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"CNTR_ORDR\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BRANCH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TSTAMP_RUN_AMT\" type=\"STRING\" size=\"256\"/><Column id=\"ET_PAY_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TSTAMP_RUN_AMT\">0</Col></Row></Rows>");
            ...
            obj = new Button("btnSave", "absolute", null, "0", "90", "21", "0", null, this.Div00.divViewCompTitle00);
            obj.set_taborder("7");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_Custom");
            obj.getSetter("objNm").set("구매요청복사버튼");
        ...
        // User Script
        this.registerScript("SCntrTstampPopup.xfdl", function(exports) {
        /***************************************************************************
        ...
        **************************************************************************/
        ...
        this.dsCntr_cancolumnchange = function(obj,e)
        {
        ...
        {
            this.dsCntr.addEventHandler("cancolumnchange", this.dsCntr_cancolumnchange, this);
            ...
            this.Div00.MaskEdit01.addEventHandler("cancharchange", this.fnTstampRunAmtCancharchange, this);
            this.Div00.divViewCompTitle00.btnSave.addEventHandler("onclick", this.btnSaveOnclick, this);

        };

        this.loadIncludeScript("SCntrTstampPopup.xfdl", true);
