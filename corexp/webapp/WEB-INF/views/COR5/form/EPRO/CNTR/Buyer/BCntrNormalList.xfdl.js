(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"BRANCH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"LANG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CNTR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"CD_CNTR_STTS\" type=\"STRING\" size=\"256\"/><Column id=\"MTRL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MTRL_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PTNR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PTNR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"TTL\" type=\"STRING\" size=\"256\"/><Column id=\"CNTR_REQR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CNTR_REQR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CRT_DAY_STR\" type=\"STRING\" size=\"256\"/><Column id=\"CRT_DAY_END\" type=\"STRING\" size=\"256\"/><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divViewCompCond01", "absolute", "0", "36", null, "56", "15", null, this);
            obj.set_cssclass("div_WF_SearchBg");
            obj.getSetter("objNm").set("");
            obj.set_taborder("0");
            this.addChild(obj.name, obj);
            obj = new Static("staWarning", "absolute", "-1", "35", null, "19", "1", null, this.divViewCompCond01);
            obj.set_taborder("49");
            obj.set_text("- 검색조건 없이 검색 시 속도가 저하 될 수 있습니다.");
            obj.set_cssclass("sta_WF_SearchText");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCntrDt", "absolute", "12", "6", "170", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("66");
            obj.set_text("계약일자");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Div("divCntrDt", "absolute", "187", "6", "260", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("67");
            obj.set_text("Div01");
            obj.getSetter("objNm").set("계약기간");
            obj.set_url("CCOMP::CompCalFromTo.xfdl");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCntrItem00", "absolute", "452", "6", "103", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("72");
            obj.set_text("협력사");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCntrReqr", "absolute", "860", "6", "75", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("76");
            obj.set_text("계약담당자");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Div("divPtnr", "absolute", "559", "6", "350", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("80");
            obj.getSetter("objNm").set("divMtrl");
            obj.set_url("CCOMP::ComSrchPtnr.xfdl");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Div("divUser", "absolute", "939", "6", null, "24", "12", null, this.divViewCompCond01);
            obj.set_taborder("81");
            ...
            obj = new Div("divViewCompBody00", "absolute", "0", "118", null, null, "15", "0", this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            obj = new Grid("grdList", "absolute", "0", "0", null, null, "0", "29", this.divViewCompBody00);
            ...
            obj = new Static("staCntrTtl", "absolute", "711", "5", "103", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("7");
            obj.set_text("계약명");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Div("divCntrTtl", "absolute", "818", "5", "220", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("8");
            obj.set_text("Div00");
            ...
            obj = new Button("btnFold", "absolute", "45.66%", "92", "56", "17", null, null, this);
            obj.set_taborder("5");
        ...
        // User Script
        this.registerScript("BCntrNormalList.xfdl", function(exports) {
        /**
         * @파일명			: BCntrPrgList
         * @생성자			: 안성민
         * @생성일시		: 2019. 02. 28.
        ...
        */  
        ...
        {
        	var param = [	{code:"CT10", sSelectType:"A", sFiltered:"S:WRI,CLO"} // 계약상태
        				];							
        ...
        */
        ...
        {	
        	...
        	//확정일자, 계약일자	
        	this.divViewCompCond01.divCntrDt.fnSetDate(this.dsCondition, "CRT_DAY_STR", "CRT_DAY_END");
        	...
        	//계약명
        	this.divViewCompCond00.divCntrTtl.fnSet(this.dsCondition		, "TTL", "fnSearch");
        ...
        {
        	if(gfnIsNull(this.dsCondition.getColumn(0,"CNTR_REQR_ID"))){
        ...
        this.fnSearch = function(svcId)
        {
        	...
        	var sSvcID = "search";
        	var sController = "epro.cntr.service.BCntrService.searchCntrNormalList";
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompCond00.staCntrTtl.addEventHandler("onclick", this.div_condition_sta_geayakGyelFgCdDist_onclick, this);
            this.btnFold.addEventHandler("onclick", this.btnFold_onclick, this);

        };

        this.loadIncludeScript("BCntrNormalList.xfdl", true);
