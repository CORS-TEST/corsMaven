(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("ubiviewerlib_localds", "absolute", "1.27%", "27", "150", "30", null, null, this);
            obj.set_taborder("6");
            obj.set_text("UbiViewerLib - LocalDS");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Button("ubiviewerlib_db", "absolute", "16.41%", "26", "150", "30", null, null, this);
            obj.set_taborder("7");
            obj.set_text("UbiViewerLib - DB");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("UbiViewerLib_HTML.xfdl", function(exports) {
        ...
        ************************************************************************************/
        ...
        {	
        	...
        	var exportType = sArg.exportType;
        	var exportFileNm = sArg.exportFileNm;
        	var ubiDataType = "";
        	var ubiData = [];
        	var ubiViewerUrl = "";
        	var reportDir = "";
        ...
        this.showUbiViewerLib_Html = function(argList)
        {
        	...
        	{
        		ubiDir = application.services["url"].url + "ubi4/work/";
        	}
        		
        	var ubiArg = "NAME#" + application.gdsUserInfo.getColumn(0,"USER_NM") + "#";
        	var ubiDataType = this.ubiDataType;	// DS : Local Dataset, SVC : Service URL
        	var ubiPrintType = "N";	// Y : 바로 출력, N : 바로 출력 안함.
        	
        	// Data : DB 사용
        	if( this.ubiDataType == "DB" ){
        	...
        	dynamicForm.setAttribute("name", "preview_form");
        	dynamicForm.setAttribute("method", "post");
        	dynamicForm.setAttribute("action", ubiUrl);
        	dynamicForm.setAttribute("target", "iframe");
        	...
        	dynamicForm.appendChild(iframe);
        	
        	var inputKey1 = document.createElement('input');
        	inputKey1.type = 'hidden';
        	inputKey1.name = 'key1';
        	inputKey1.value = key1;
        	dynamicForm.appendChild(inputKey1);
        	
        	var inputKey2 = document.createElement('input');
        	inputKey2.type = 'hidden';
        	inputKey2.name = 'key2';
        	inputKey2.value = key2;
        	dynamicForm.appendChild(inputKey2);
        	
        	var inputKey3 = document.createElement('input');
        	inputKey3.type = 'hidden';
        	inputKey3.name = 'key3';
        	inputKey3.value = key3;
        	dynamicForm.appendChild(inputKey3);
        	...
        	inputExportDir.value = exportUrl;
        	...
        	inputExportType.value = exportType;
        	...
        	//var newWidth = 1, newHeight = 1, newLeft = 0, newTop = 0;
        	//var popWindow = window.open('about:blank', 'UBI_WIN', 'left=' + newLeft + ',top=' + newTop + ',width=' + newWidth + ',height=' + newHeight + ',scrollbars=yes,resizable=yes');        	
        	//popWindow.close();
        ...
        this.UbiReport_ontimer = function(obj,e)
        {
        	try{
        		...
        		//trace("timerCnt :> " + timerCnt + "   |   result :> [" + result.trim() +"]");
        	  
        		if(result.trim()=="success" || timerCnt >= 10)
        		{
        			this.killTimer( 0 );
        			this.parent.ubi_callback();
        			trace("killTimer");
        		}
        ...
        this.on_initEvent = function()
        {
            ...
            this.ubiviewerlib_db.addEventHandler("onclick", this.ubiviewerlib_db_onclick, this);

        };

        this.loadIncludeScript("UbiViewerLib_HTML.xfdl", true);
