(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"TTL\" size=\"40\" type=\"string\"/><Column id=\"PTNR_NM\" size=\"600\" type=\"string\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"553\"/><Column size=\"83\"/><Column size=\"121\"/><Column size=\"95\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell text=\"계약번호\"/><Cell col=\"1\" text=\"계약명\"/><Cell col=\"2\" text=\"계약일자\"/><Cell col=\"3\" text=\"협력사\"/><Cell col=\"4\" text=\"계약담당자\"/></Band><Band id=\"body\"><Cell text=\"bind:CNTR_NO\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:TTL\"/><Cell col=\"2\" style=\"align: ;\" text=\"bind:CNTR_REQ_DT\" mask=\"@@@@.@@.@@\"/><Cell col=\"3\" style=\"align:left;\" text=\"bind:PTNR_NM\"/><Cell col=\"4\" text=\"bind:CRTR_NM\" maskchar=\" \"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("edt_ptnrNm", "absolute", "367", "10", "117", "24", null, null, this.div_condition);
            obj.set_taborder("6");
            obj.set_text("협력사");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.getSetter("lbcd").set("");
            this.div_condition.addChild(obj.name, obj);
            obj = new Edit("edt_Ttl", "absolute", "484", "10", "250", "24", null, null, this.div_condition);
            obj.set_taborder("7");
            obj.set_lengthunit("utf8");
            obj.set_cssclass("edt_default");
            obj.getSetter("objNm").set("계약명");
            this.div_condition.addChild(obj.name, obj);
            obj = new Static("edt_ttl", "absolute", "0", "10", "117", "24", null, null, this.div_condition);
            obj.set_taborder("8");
            obj.set_text("계약명");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.getSetter("lbcd").set("");
            this.div_condition.addChild(obj.name, obj);
            obj = new Edit("edt_Ttl00", "absolute", "117", "10", "250", "24", null, null, this.div_condition);
            obj.set_taborder("9");
            obj.set_lengthunit("utf8");
            obj.set_cssclass("edt_default");
            obj.getSetter("objNm").set("계약명");
            ...
            obj = new Static("sta_title00", "absolute", "0%", "5", null, "30", "64.06%", null, this);
            obj.set_taborder("1");
            obj.set_text("관련계약참조");
        ...
        // User Script
        this.addIncludeScript("PCTRB100P02.xfdl", "lib::lib_all.xjs");
        this.registerScript("PCTRB100P02.xfdl", function(exports) {
        /**
        ...
        */
        ...
        this.loadIncludeScript("PCTRB100P02.xfdl", true);
