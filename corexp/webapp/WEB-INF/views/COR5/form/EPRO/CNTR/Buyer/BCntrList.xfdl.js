(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsModify", this);
            obj._setContents("<ColumnInfo><Column id=\"CNTR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"BRANCH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"NEW_CNTR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LANG_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCntrCfmDt", "absolute", "-3", "6", "132", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("66");
            obj.set_text("계약확정일자");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Div("divCntrCfmDt", "absolute", "134", "6", "260", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("67");
            obj.set_text("Div01");
            obj.getSetter("objNm").set("계약기간");
            obj.set_url("CCOMP::CompCalFromTo.xfdl");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCntrDt", "absolute", "-3", "35", "132", "24", null, null, this.divViewCompCond01);
            obj.set_taborder("68");
            obj.set_text("계약일자");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_align("right middle");
            ...
            obj.set_taborder("1");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"280\"/><Column size=\"90\"/><Column size=\"114\"/><Column size=\"104\"/><Column size=\"104\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"70\"/><Column size=\"82\"/><Column size=\"82\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\"/><Cell col=\"1\" text=\"계약번호\"/><Cell col=\"2\" text=\"계약상태\"/><Cell col=\"3\" text=\"계약명\"/><Cell col=\"4\" text=\"계약유형\"/><Cell col=\"5\" text=\"협력사명\"/><Cell col=\"6\" text=\"계약시작일자\"/><Cell col=\"7\" text=\"계약종료일자\"/><Cell col=\"8\" text=\"총계약금액\"/><Cell col=\"9\" text=\"작성일자\"/><Cell col=\"10\" text=\"담당자\"/><Cell col=\"11\" text=\"구매유형\" combodataset=\"ds_cdET31\" combocodecol=\"CD_NM_LO\" combodatacol=\"CD_ID\"/><Cell col=\"12\" text=\"회람내역\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" text=\"bind:CHECKED\"/><Cell col=\"1\" style=\"color:blue;color2:blue;\" cssclass=\"cell_link\" text=\"bind:CNTR_NO\" maskchar=\" \"/><Cell col=\"2\" text=\"bind:CD_CNTR_STTS_NM\"/><Cell col=\"3\" style=\"align:left;\" cssclass=\"cell_link\" text=\"bind:TTL\"/><Cell col=\"4\" text=\"bind:CD_CNTR_CTGR_NM\"/><Cell col=\"5\" style=\"align:left;\" cssclass=\"cell_link\" text=\"bind:PTNR_NM\"/><Cell col=\"6\" text=\"bind:CNTR_BGN_DAY\" mask=\"@@@@.@@.@@\" maskchar=\" \"/><Cell col=\"7\" text=\"bind:CNTR_END_DAY\" mask=\"@@@@.@@.@@\" maskchar=\" \"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" text=\"bind:CNTR_SUM\" mask=\"#,##0\"/><Cell col=\"9\" displaytype=\"date\" edittype=\"none\" text=\"bind:CRT_DT\" mask=\"yyyy.MM.dd\" maskchar=\" \" calendardisplaynulltype=\"nulltext\"/><Cell col=\"10\" cssclass=\"cell_link\" text=\"bind:CNTR_REQR_NM\"/><Cell col=\"11\" style=\"align:center;\" text=\"bind:CD_DOC_CTGR_NM\"/><Cell col=\"12\" displaytype=\"expr:CNTR_TRNR_ID=='' ? &quot;normal&quot; : &quot;button&quot;\" edittype=\"expr:CNTR_TRNR_ID=='' ? &quot;none&quot; : &quot;button&quot;\" text=\"expr:CNTR_TRNR_ID=='' ? &quot;없음&quot; : &quot;보기&quot;\"/></Band></Format></Formats>");
            ...
            this.divViewCompBody00.addChild(obj.name, obj);
            obj = new Button("btnCopyCntr", "absolute", null, "0", "80", "24", "85", null, this.divViewCompBody00);
            obj.set_taborder("3");
            obj.set_text("변경계약");
            obj.set_cssclass("btn_WF_Custom");
            this.divViewCompBody00.addChild(obj.name, obj);
            obj = new Button("btnWrtPo", "absolute", null, "0", "80", "24", "2", null, this.divViewCompBody00);
            obj.set_taborder("4");
            obj.set_text("발주작성");
            obj.set_cssclass("btn_WF_Custom");
            ...
            obj.style.set_align("right middle");
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Combo("cboCdCntrStts", "absolute", "559", "5", "147", "24", null, null, this.divViewCompCond00);
            this.divViewCompCond00.addChild(obj.name, obj);
            ...
            obj.style.set_align("right middle");
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Combo("cboCdDocCtgr", "absolute", "819", "5", "146", "24", null, null, this.divViewCompCond00);
            this.divViewCompCond00.addChild(obj.name, obj);
            obj.set_taborder("8");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","divViewCompCond00.cboCdDocCtgr","value","dsCondition","CD_DOC_CTGR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BCntrList.xfdl", function(exports) {
        /**
         * @파일명			: BCntrPrgList
         * @생성자			: 안성민
         * @생성일시		: 2019. 02. 28.
        ...
        */
        ...
        /**
          ...
          * @desc     	: 변경계약
          */
        this.fnCopyCntr = function(obj,e)
        {
        	gfnAlert("변경계약");
        	return;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompBody00.btnCopyCntr.addEventHandler("onclick", this.fnCopyCntr, this);
            this.divViewCompBody00.btnWrtPo.addEventHandler("onclick", this.fnWrtPo, this);
        ...
        this.loadIncludeScript("BCntrList.xfdl", true);
