    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("BCntrCtgrPop");
                this.set_titletext("계약유형팝업");
            ...
            obj.set_binddataset("dsCdCT11");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"110\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"계약유형\"/></Band><Band id=\"body\"><Cell text=\"bind:CD_NM_LO\"/></Band></Format></Formats>");
        ...
        // User Script
        this.registerScript("BCntrCtgrPop.xfdl", function(exports) {
        /**
        ...
        */  
        ...
        this.loadIncludeScript("BCntrCtgrPop.xfdl", true);
