(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_title00", "absolute", "0%", "5", null, "30", "91.84%", null, this);
            obj.set_taborder("2");
            obj.set_text("출력");
        ...
        // User Script
        this.registerScript("PCTRB100P00.xfdl", function(exports) {
        /**
        ...
        */
        ...
        this.loadIncludeScript("PCTRB100P00.xfdl", true);
