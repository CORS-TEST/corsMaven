(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("5");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"305\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"40\"/></Columns><Rows><Row band=\"head\" size=\"32\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell expr=\"\" text=\"품목코드\"/><Cell col=\"1\" expr=\"\" text=\"품목명\"/><Cell col=\"2\" expr=\"\" text=\"단위\"/><Cell col=\"3\" expr=\"\" text=\"단가\"/><Cell col=\"4\" expr=\"\" text=\"소싱그룹명\"/><Cell col=\"5\"/></Band><Band id=\"body\"><Cell text=\"bind:MTRL_CD\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:MTRL_NM2\"/><Cell col=\"2\" text=\"bind:CD_PO_UNIT_NM\"/><Cell col=\"3\" displaytype=\"number\" mask=\"#,##0.00\" style=\"align:right;\" text=\"bind:UNT_PRICE\"/><Cell col=\"4\" style=\"align:left;\" text=\"bind:SRC_GRP_NM2\"/><Cell col=\"5\" displaytype=\"button\" expr=\"expr:BTN==&quot;추가&quot;?gfnMultiLabel(&quot;EPRO_LABEL_00144&quot;):gfnMultiLabel(&quot;EPRO_LABEL_00172&quot;)\" text=\"bind:BTN\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staMtrlCd", "absolute", "361", "17", "100", "24", null, null, this);
            ...
            obj = new Edit("edMtrlNm", "absolute", "571", "17", "200", "24", null, null, this);
            obj.getSetter("objNm").set("협력사명");
            obj.set_taborder("14");
            this.addChild(obj.name, obj);

            obj = new Edit("edMtrlCd", "absolute", "468", "17", "100", "24", null, null, this);
            ...
            obj = new Static("staMtrlNm00", "absolute", "16", "17", "100", "24", null, null, this);
            obj.set_cssclass("sta_WF_SearchLabel");
            ...
            obj = new Div("divComp01", "absolute", "121", "18", "233", "23", null, null, this);
            obj.set_taborder("24");
        ...
        // User Script
        this.registerScript("BMtrlSrchMultiPopup.xfdl", function(exports) {
        /**
         * @파일명       	: BMtrlSrchMultiPopup.xfdl
         * @생성자       	: 송태봉
         * @생성일자     	: 2017. 8. 31.
         * @설명			    : 품목검색멀티팝업
         * @최종수정자		: 송태봉
        ...
        */ 
        ...
        this.loadIncludeScript("BMtrlSrchMultiPopup.xfdl", true);
