    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_name("CompRemote");
                this.set_titletext("리모콘");
        ...
        // User Script
        this.registerScript("CompRemote.xfdl", function(exports) {
        /**
         * @파일명       	: CompRemote.xfdl
         * @생성자       	: 한민희
         * @생성일자     	: 2017. 8. 17.
        ...
        */  
        ...
        {
        	/*
        		폼이 온로드 되면(버튼 생성할 준비가 완료되면)
        		gfnRemoteSubFormOnloaded를 호출하고 그 함수에서는
        		arrparam:Object(버튼명과 클릭이벤트 함수가 들어있는 오브젝트)를 아큐먼트로 하는 fnSetBtn를 호출한다.
        	*/
        	gfnRemoteSubFormOnloaded(obj);
        }
        ...
        {	
        	...
        	for(var i=0; i<arrparam.length; i++){
        		...
        		var eventFunc = this.parent.divWork.lookup(arrparam[i].clickEventFunc);
        		objButton.addEventHandler("onclick", eventFunc, this.parent.divWork);
        		...
        		//공통 visible 데이터셋 적용
        		var objBindItemVisible = new BindItem("bindVislbleBtnRemote_" + i, "btnRemote_" + i, "visible", "dsObjBindVi", "btnRemote_" + i);
        		this.addChild("bindVislbleBtnRemote_" + i, objBindItemVisible);
        		objBindItemVisible.bind();
        		
        		//공통 enable 데이터셋 적용
        		var objBindItemEnable = new BindItem("bindEnableBtnRemote_" + i, "btnRemote_" + i, "enable", "dsObjBindEn", "btnRemote_" + i);
        		this.addChild("bindEnableBtnRemote_" + i, objBindItemEnable);
        		objBindItemEnable.bind();
        	}	
        ...
        {
        	//접기
        	//if(this.getOffsetWidth() > obj.getOffsetWidth()){
        	if(this.getOffsetWidth() > obj.getOffsetWidth() + 9){
        // 		this.divTitle.set_visible(false);
        // 		this.setOffsetLeft(this.getOffsetLeft() + this.getOffsetWidth() - obj.getOffsetWidth());		
        //  		this.setOffsetWidth(obj.getOffsetWidth());
        //  		this.setOffsetHeight(obj.getOffsetHeight());
        ...
        // 		this.setOffsetLeft(this.getOffsetLeft() - this.fvWidth + obj.getOffsetWidth());
        ...
        this.fnDivBottomMoveOnclick = function(obj,e)
        {
        	...
        	if(framesInfo[openId]){
        		var yy = framesInfo[openId].form.divWork.vscrollbar.incbutton.getOffsetBottom();
        		framesInfo[openId].form.divWork.vscrollbar.set_pos(yy);
        	}
        }
        ...
        this.fnDivTopMoveOnclick = function(obj,e)
        {
        	...
        	var framesInfo = application.gv_workFrameSet.frames;
        	if(framesInfo[openId]){
        		var yy = framesInfo[openId].form.divWork.vscrollbar.decbutton.getOffsetTop();
        		framesInfo[openId].form.divWork.vscrollbar.set_pos(yy);
        	}
        }
        ...
        this.loadIncludeScript("CompRemote.xfdl", true);
