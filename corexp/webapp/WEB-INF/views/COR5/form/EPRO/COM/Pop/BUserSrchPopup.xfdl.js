(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_ID\" size=\"256\" type=\"STRING\"/><Column id=\"USER_NM\" size=\"256\" type=\"STRING\"/><Column id=\"BRANCH_CD\" size=\"256\" type=\"STRING\"/></ColumnInfo>");
            ...
            obj.set_taborder("5");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row band=\"head\" size=\"32\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell expr=\"\" text=\"부서명\"/><Cell col=\"1\" expr=\"\" text=\"사용자 ID\"/><Cell col=\"2\" expr=\"\" text=\"사용자명\"/><Cell col=\"3\" expr=\"\" text=\"직책\"/><Cell col=\"4\" expr=\"\" text=\"핸드폰\"/><Cell col=\"5\" expr=\"\" text=\"이메일\"/></Band><Band id=\"body\"><Cell text=\"bind:DEPT_NM\"/><Cell col=\"1\" text=\"bind:USER_ID\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:USER_NM\"/><Cell col=\"3\" text=\"bind:PSTN\"/><Cell col=\"4\" text=\"bind:HP\"/><Cell col=\"5\" text=\"bind:EMAIL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj = new Static("staUserId", "absolute", "0", "5", "110", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("61");
            obj.set_text("사용자ID");
            ...
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Edit("edtUserNm", "absolute", "560", "5", "200", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("63");
            obj.getSetter("objNm").set("품목명");
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Edit("edtUserId", "absolute", "110", "5", "120", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("64");
            obj.getSetter("objNm").set("품목코드");
            this.divViewCompCond00.addChild(obj.name, obj);
            obj = new Static("staUserNm", "absolute", "450", "5", "110", "24", null, null, this.divViewCompCond00);
            obj.set_taborder("65");
            obj.set_text("사용자명");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            ...
            obj = new BindItem("item12","divViewCompCond00.edtUserId","value","dsSrchOpt","USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","divViewCompCond00.edtUserNm","value","dsSrchOpt","USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BUserSrchPopup.xfdl", function(exports) {
        /**
        ...
        */ 
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompCond00.staUserId.addEventHandler("onclick", this.Tab00_tabpage1_div_condition_sta_WFSA_LabelP_onclick, this);
            this.divViewCompCond00.btnSearch.addEventHandler("onclick", this.fnSearch, this);
            this.divViewCompCond00.edtUserNm.addEventHandler("onkeyup", this.fnOnkeyup, this);
            this.divViewCompCond00.edtUserId.addEventHandler("onkeyup", this.fnOnkeyup, this);
            this.divViewCompCond00.staUserNm.addEventHandler("onclick", this.Tab00_tabpage1_div_condition_sta_WFSA_LabelP_onclick, this);

        };

        this.loadIncludeScript("BUserSrchPopup.xfdl", true);
