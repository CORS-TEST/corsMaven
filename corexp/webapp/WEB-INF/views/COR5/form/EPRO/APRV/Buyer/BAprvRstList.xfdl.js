    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("BAprvRstList");
                this.set_titletext("완료리스트");
            ...
            obj._setContents("<ColumnInfo><Column id=\"BRANCH_CD\" size=\"256\" type=\"STRING\"/><Column id=\"USER_ID\" size=\"256\" type=\"STRING\"/><Column id=\"TTL\" size=\"256\" type=\"STRING\"/><Column id=\"APP_DOC_ID\" size=\"256\" type=\"STRING\"/><Column id=\"CD_APRV_DOC_CTGR\" size=\"256\" type=\"STRING\"/><Column id=\"START_REQ_DT\" size=\"256\" type=\"STRING\"/><Column id=\"END_REQ_DT\" size=\"256\" type=\"STRING\"/><Column id=\"REQR_ID\" size=\"256\" type=\"STRING\"/><Column id=\"REQR_NM\" size=\"256\" type=\"STRING\"/><Column id=\"START_CMPLT_DT\" size=\"256\" type=\"STRING\"/><Column id=\"END_CMPLT_DT\" size=\"256\" type=\"STRING\"/><Column id=\"APRVR_ID\" size=\"256\" type=\"STRING\"/><Column id=\"APRVR_NM\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_ITEM1\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_ITEM2\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_ITEM3\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_ITEM4\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_TYPE1\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_TYPE2\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_TYPE3\" size=\"256\" type=\"STRING\"/><Column id=\"SORT_TYPE4\" size=\"256\" type=\"STRING\"/><Column id=\"LANG_CD\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj.set_text("기안자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtReqId", "absolute", "170", "34", "100", "24", null, null, this.divViewCompCond01);
            ...
            obj.set_taborder("3");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtReqNm", "absolute", "273", "34", "130", "24", null, null, this.divViewCompCond01);
            obj.set_lengthunit("utf8");
            obj.getSetter("objNm").set("평가담당자명");
            obj.set_taborder("4");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Button("btnEvalReqr", "absolute", "404", "34", "24", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("btn_WF_SearchSmall");
            obj.getSetter("objNm").set("평가담당자 검색 버튼");
            obj.set_taborder("5");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staReqDt", "absolute", "0", "5", "170", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            obj.set_taborder("14");
            obj.set_text("기안일자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Div("divCmpltDt", "absolute", "170", "92", "257", "24", null, null, this.divViewCompCond01);
            obj.getSetter("objNm").set("요청일자");
            obj.set_taborder("20");
            obj.set_text("Div01");
            obj.set_url("CCOMP::CompCalFromTo.xfdl");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staAprvr", "absolute", "0", "63", "170", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            obj.set_taborder("21");
            obj.set_text("최종승인자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtAprvrId", "absolute", "170", "63", "100", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("readonly");
            obj.set_lengthunit("utf8");
            obj.set_maxlength("10");
            obj.getSetter("objNm").set("평가담당자ID");
            obj.set_taborder("22");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtAprvrNm", "absolute", "273", "63", "130", "24", null, null, this.divViewCompCond01);
            obj.set_lengthunit("utf8");
            obj.getSetter("objNm").set("평가담당자명");
            obj.set_taborder("23");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Button("btnAprvr", "absolute", "404", "63", "24", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("btn_WF_SearchSmall");
            obj.getSetter("objNm").set("평가담당자 검색 버튼");
            obj.set_taborder("24");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staCmpltDt", "absolute", "0", "92", "170", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            obj.set_taborder("26");
            ...
            obj.set_taborder("27");
            obj.set_text("승인문서의 기안일자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staAdvice01", "absolute", "428", "38", "303", "24", null, null, this.divViewCompCond01);
            obj.style.set_background("transparent URL('img::img_WF_Question.png')");
            obj.style.set_padding("0 0 7 25");
            obj.set_taborder("28");
            obj.set_text("승인문서의 기안자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staAdvice02", "absolute", "428", "67", "303", "24", null, null, this.divViewCompCond01);
            obj.style.set_background("transparent URL('img::img_WF_Question.png')");
            obj.style.set_padding("0 0 7 25");
            obj.set_taborder("29");
            obj.set_text("승인문서의 최종승인자");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staAdvice03", "absolute", "428", "96", "303", "24", null, null, this.divViewCompCond01);
            obj.style.set_background("transparent URL('img::img_WF_Question.png')");
            obj.style.set_padding("0 0 7 25");
            obj.set_taborder("30");
            ...
            obj = new Div("divViewCompBody00", "absolute", "0", "199", null, null, "15", "0", this);
            obj.set_taborder("3");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("6");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"110\"/><Column size=\"93\"/><Column size=\"120\"/><Column size=\"400\"/><Column size=\"120\"/><Column size=\"109\"/><Column size=\"120\"/><Column size=\"93\"/></Columns><Rows><Row band=\"head\" size=\"32\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell expr=\"\" text=\"승인문서번호\" tooltiptext=\"\"/><Cell col=\"1\" expr=\"\" text=\"승인상태\" tooltiptext=\"\"/><Cell col=\"2\" expr=\"\" text=\"승인유형\" tooltiptext=\"\"/><Cell col=\"3\" expr=\"\" text=\"승인문서명\" tooltiptext=\"\"/><Cell col=\"4\" expr=\"\" text=\"기안자\" tooltiptext=\"\"/><Cell col=\"5\" expr=\"\" text=\"기안일자\" tooltiptext=\"\"/><Cell col=\"6\" expr=\"\" text=\"최종승인자\" tooltiptext=\"\"/><Cell col=\"7\" expr=\"\" text=\"승인완료일자\" tooltiptext=\"\"/></Band><Band id=\"body\"><Cell cssclass=\"cell_link\" text=\"bind:APP_DOC_ID\" tooltiptext=\"bind:APP_DOC_ID\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:CD_APRV_STTS_NM\" tooltiptext=\"bind:CD_APRV_STTS_NM\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:CD_APRV_DOC_CTGR_NM\" tooltiptext=\"bind:CD_APRV_DOC_CTGR_NM\"/><Cell col=\"3\" style=\"align:left;\" text=\"bind:TTL\" tooltiptext=\"bind:TTL\"/><Cell col=\"4\" cssclass=\"cell_link\" style=\"align:center;\" text=\"bind:REQR_NM\" tooltiptext=\"bind:REQR_NM\"/><Cell calendardisplaynulltype=\"none\" col=\"5\" displaytype=\"date\" mask=\"yyyy-MM-dd\" text=\"bind:REQ_DT\" tooltiptext=\"bind:REQ_DT\"/><Cell col=\"6\" cssclass=\"cell_link\" style=\"align:center;\" text=\"bind:APRVR_NM\" tooltiptext=\"bind:APRVR_NM\"/><Cell calendardisplaynulltype=\"none\" col=\"7\" displaytype=\"date\" mask=\"yyyy-MM-dd\" text=\"bind:APRV_CMPLT_DT\" tooltiptext=\"bind:APRV_CMPLT_DT\"/></Band></Format></Formats>");
            ...
            obj = new Button("btnFold", "absolute", "45.66%", "181", "56", "17", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 0, 146, this.divViewCompCond01,
            	//-- Layout function
            	function(p) {
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","divViewCompCond00.cboDocCtgr","value","dsCondition","CD_APRV_DOC_CTGR");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","divViewCompCond01.edtReqId","value","dsCondition","REQR_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","divViewCompCond01.edtReqNm","value","dsCondition","REQR_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","divViewCompCond01.edtAprvrId","value","dsCondition","APRVR_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","divViewCompCond01.edtAprvrNm","value","dsCondition","APRVR_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staAprvrLangBind2017110317184219422","divViewCompCond01.staAprvr","text","gdsLabel","EPRO_LABEL_00516");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("dviReqDtLangBind2017110317184276522","divViewCompCond01.dviReqDt","text","gdsLabel","EPRO_LABEL_00270");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","divViewCompCond01.staAdvice01","text","gdsLabel","EPRO_LABEL_00886");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BAprvRstList.xfdl", function(exports) {
        /**
        ...
        */
        ...
        /**
          ...
          * @desc   : 기안자 검색
          */
        this.fnSrchAprvr = function(obj,e)
        {
        	var sArg = { 
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompCond01.staReqUser.addEventHandler("onclick", this.Div_SOption_sta_WFDA_Label04_onclick, this);
            this.divViewCompCond01.edtReqNm.addEventHandler("onkeyup", this.fnOnkeyup, this);
            this.divViewCompCond01.edtReqNm.addEventHandler("ontextchanged", this.fnOntextchanged, this);
            this.divViewCompCond01.btnEvalReqr.addEventHandler("onclick", this.fnSrchReq, this);
            this.divViewCompCond01.staAprvr.addEventHandler("onclick", this.Div_SOption_sta_WFDA_Label04_onclick, this);
            this.divViewCompCond01.edtAprvrNm.addEventHandler("onkeyup", this.fnOnkeyup, this);
            this.divViewCompCond01.edtAprvrNm.addEventHandler("ontextchanged", this.fnOntextchanged, this);
            this.divViewCompCond01.btnAprvr.addEventHandler("onclick", this.fnSrchAprvr, this);
        ...
        this.loadIncludeScript("BAprvRstList.xfdl", true);
