(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            this.addChild(obj.name, obj);
            obj = new Static("staCdScjdEvalType00", "absolute", "0", "63", "170", "24", null, null, this.divViewCompCond01);
            ...
            obj = new Edit("edtMtrlCd", "absolute", "170", "63", "85", "24", null, null, this.divViewCompCond01);
            ...
            obj.set_taborder("5");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtMtrlNm", "absolute", "260", "63", "105", "24", null, null, this.divViewCompCond01);
            obj.set_lengthunit("utf8");
            obj.getSetter("objNm").set("품목명");
            obj.set_taborder("6");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Button("btnEvalReqr00", "absolute", "369", "63", "21", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("btn_WF_SearchSmall");
            obj.getSetter("objNm").set("평가담당자 검색 버튼");
            obj.set_taborder("7");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtRfqReqNo", "absolute", "170", "5", "220", "24", null, null, this.divViewCompCond01);
            obj.getSetter("objNm").set("입찰요청번호");
            obj.style.set_align("left middle");
            obj.set_taborder("1");
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Static("staRfqReqNo", "absolute", "0", "5", "170", "24", null, null, this.divViewCompCond01);
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.getSetter("objNm").set("입찰요청번호");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            ...
            this.divViewCompCond01.addChild(obj.name, obj);
            obj = new Edit("edtTtl", "absolute", "170", "34", "220", "24", null, null, this.divViewCompCond01);
            ...
            obj.set_taborder("1");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"130\"/><Column size=\"50\"/><Column size=\"350\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"150\"/></Columns><Rows><Row band=\"head\" size=\"32\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell expr=\"\" text=\"입찰번호\" tooltiptext=\"\"/><Cell col=\"1\" expr=\"\" text=\"차수\" tooltiptext=\"\"/><Cell col=\"2\" expr=\"\" text=\"입찰요청명\" tooltiptext=\"\"/><Cell col=\"3\" edittype=\"normal\" expr=\"\" text=\"입찰상태\" tooltiptext=\"\"/><Cell col=\"4\" expr=\"\" text=\"담당자명\" tooltiptext=\"\"/><Cell col=\"5\" expr=\"\" text=\"입찰공고일\" tooltiptext=\"\"/><Cell col=\"6\" expr=\"\" text=\"승인완료일자\" tooltiptext=\"\"/><Cell col=\"7\" expr=\"\" text=\"입찰마감일\"/><Cell col=\"8\" expr=\"\" text=\"구분\"/><Cell col=\"9\" expr=\"\" style=\"align:left;\" text=\"입찰목적\"/></Band><Band id=\"body\"><Cell combodisplay=\"edit\" style=\"selectcolor: ;\" text=\"bind:RFQ_REQ_NO\" tooltiptext=\"bind:RFQ_REQ_NO\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:RFQ_ODR\" tooltiptext=\"bind:RFQ_ODR\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:TTL\" tooltiptext=\"bind:TTL\"/><Cell col=\"3\" edittype=\"none\" style=\"align:left;color: ;\" text=\"bind:CD_RFQ_STTS_NM\" tooltiptext=\"bind:CD_RFQ_STTS_NM\"/><Cell col=\"4\" style=\"align:center;\" text=\"bind:CRTR_NM\" tooltiptext=\"bind:CRTR_NM\"/><Cell calendardisplaynulltype=\"none\" col=\"5\" displaytype=\"date\" mask=\"yyyy-MM-dd\" style=\"align:center;\" text=\"bind:REQ_DT\" tooltiptext=\"bind:REQ_DT\"/><Cell calendardisplaynulltype=\"none\" col=\"6\" displaytype=\"date\" mask=\"yyyy-MM-dd\" style=\"align:center;\" text=\"bind:CMPLT_APP_CMPLT_DT\" tooltiptext=\"bind:CMPLT_APP_CMPLT_DT\"/><Cell col=\"7\" style=\"align:center;\" text=\"bind:RFQ_END_DT\" tooltiptext=\"bind:RFQ_END_DT\"/><Cell col=\"8\" text=\"bind:CD_RFQ_TYPE_NM\" tooltiptext=\"bind:CD_RFQ_TYPE_NM\"/><Cell col=\"9\" style=\"align:left;\" text=\"bind:CD_RFQ_AIM_NM\" tooltiptext=\"bind:CD_RFQ_AIM_NM\"/></Band></Format></Formats>");
            ...
            obj.set_taborder("3");
            this.addChild(obj.name, obj);
            obj = new Combo("cboCdRfqStts", "absolute", "170", "5", "220", "24", null, null, this.divViewCompCond00);
            this.divViewCompCond00.addChild(obj.name, obj);
            obj.set_codecolumn("CD_ID");
            obj.set_datacolumn("CD_NM_LO");
            obj.set_innerdataset("@dsCdET10");
            obj.getSetter("objNm").set("상태");
            obj.set_taborder("1");
            obj = new Static("staCdRfqStts", "absolute", "0", "5", "170", "24", null, null, this.divViewCompCond00);
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.getSetter("objNm").set("상태");
            obj.style.set_padding("0 10 0 6");
            obj.style.set_align("right middle");
            ...
            obj = new BindItem("item2","divViewCompCond00.cboCdRfqStts","value","dsCondition","CD_RFQ_STTS");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","divViewCompCond01.edtMtrlCd","value","dsCondition","MTRL_CD");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","divViewCompCond01.edtMtrlNm","value","dsCondition","MTRL_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staCdScjdEvalType00Vi","divViewCompCond01.staCdScjdEvalType00","visible","dsObjBindVi","staCdScjdEvalType00");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staCdScjdEvalType00En","divViewCompCond01.staCdScjdEvalType00","enable","dsObjBindEn","staCdScjdEvalType00");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("btnEvalReqr00Vi","divViewCompCond01.btnEvalReqr00","visible","dsObjBindVi","btnEvalReqr00");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("btnEvalReqr00En","divViewCompCond01.btnEvalReqr00","enable","dsObjBindEn","btnEvalReqr00");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("cboCdRfqSttsVi","divViewCompCond00.cboCdRfqStts","visible","dsObjBindVi","cboCdRfqStts");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("cboCdRfqSttsEn","divViewCompCond00.cboCdRfqStts","readonly","dsObjBindEn","cboCdRfqStts");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staCdRfqSttsVi","divViewCompCond00.staCdRfqStts","visible","dsObjBindVi","staCdRfqStts");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staCdRfqSttsEn","divViewCompCond00.staCdRfqStts","enable","dsObjBindEn","staCdRfqStts");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staRfqReqNoVi","divViewCompCond01.staRfqReqNo","visible","dsObjBindVi","staRfqReqNo");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("staRfqReqNoEn","divViewCompCond01.staRfqReqNo","enable","dsObjBindEn","staRfqReqNo");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BRtpRfqPrgList.xfdl", function(exports) {
        /**
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divViewCompCond01.edtMtrlNm.addEventHandler("ontextchanged", this.fnOnTextChanged, this);
            this.divViewCompCond01.btnEvalReqr00.addEventHandler("onclick", this.fnMtrlSearch, this);
        ...
        this.loadIncludeScript("BRtpRfqPrgList.xfdl", true);
