...
if (nexacro.Browser != "Runtime") {
	if (!nexacro._init_platform_HTML5) {
		...
		nexacro.SupportTouch = ("ontouchstart" in window || window.navigator.pointerEnabled || window.navigator.msPointerEnabled || window.navigator.maxTouchPoints > 0);
		...
		if (nexacro.Browser != "IE" || (nexacro.Browser == "IE" && nexacro.OSVersion >= 6.0)) {
			nexacro._syshandler_onkeydown = function (_sysEvent, node, evt) {
				...
				if (win && elem) {
					...
					else if ((nexacro.Browser == "IE" || nexacro.Browser == "Edge") && keycode == nexacro.Event.KEY_BACKSPACE) {
		...
		nexacro.__setViewportScale = function () {
			...
			if ((nexacro.OS == "iOS" && set_viewport_twice_ranged_scale) || (nexacro.OS == "Android" && set_viewport_twice_ranged_scale && minimum_scale < maximum_scale)) {
				...
				if (nexacro.OS == "iOS" || nexacro.Browser != "Chrome" || (isSamsungBrowser && nexacro.Browser == "Chrome" && nexacro.BrowserVersion < 59) || (!isSamsungBrowser && nexacro.Browser == "Chrome" && nexacro.BrowserVersion < 61)) {
					setTimeout(function () {
		...
		if (nexacro.Browser == "Chrome" || nexacro.OS == "iOS") {
