...
if (!nexacro.Combo) {
	...
	_pCombo.on_fire_onkillfocus = function (obj, fromObj) {
		...
		if (this.comboedit) {
			...
			if (input_elem && nexacro.Browser != "Edge") {
				var scrollLeft = input_elem.getScrollLeft();
				var textPosition = this.overflowtextposition;

				switch (textPosition) {
					case "keep":
						if ((nexacro.Browser == "Chrome" || nexacro.Browser == "Safari" || nexacro.Browser == "MobileSafari") && !this.autoselect) {
	...
	_pComboEditCtrl.on_apply_custom_setfocus = function (evt_name) {
		...
		if (api && input_elem) {
			...
			if (nexacro.Browser == "Edge" && evt_name == "focus") {
				if (this._setcaret) {
				...
				if ((nexacro.Browser == "Chrome" || nexacro.Browser == "Safari" || nexacro.Browser == "MobileSafari") && evt_name == "lbuttondown" && !nexacro._isNull(textPosition)) {
