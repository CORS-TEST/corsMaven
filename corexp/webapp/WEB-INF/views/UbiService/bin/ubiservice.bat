...
echo ----------------------------------------
echo.
set JAVA_DIR=D:\01.Project\ebay\jdk1.8.0_131
set UBISERVICE_DIR=D:\01.Project\ebay\workspace\ebay\WebContent\UbiService
set PROPERTY_DIR=%UBISERVICE_DIR%
set FONT_DIR=%UBISERVICE_DIR%\fonts\
set XMS=512M
set XMX=1024M
set CLASSPATH=D:\01.Project\ebay\workspace\ebay\WebContent\UbiService\lib\UbiServer.jar
