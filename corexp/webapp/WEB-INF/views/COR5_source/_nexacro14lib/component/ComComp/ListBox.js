...
if (!nexacro.ListBox) {
	...
	_pListBox.on_fire_sys_onkeyup = function (key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp) {
		this._shiftKey = shift_key;
		this._ctrlKey = ctrl_key;
		this._altKey = alt_key;

		return nexacro.Component.prototype.on_fire_sys_onkeyup.call(this, key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp);
	};
