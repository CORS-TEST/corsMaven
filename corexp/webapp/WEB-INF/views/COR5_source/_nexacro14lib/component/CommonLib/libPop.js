...
/*
 ...
 ● gfnSearchComSl              : 부서검색팝업
 ● gfnSearchComSlCallBack      : 부서검색팝업_콜백
 ● gfnSearchComUser            : 담당자검색팝업
 ● gfnSearchComUserCallBack    : 담당자검색팝업_콜백
 */

/**
  * @함수명	: gfnCallComDocTypePopup
  ...
  * @desc		: 구매유형
  */
gfnCallComDocTypePopup	= function(obj, svcId, callback, arg)
{
	if(gfnIsNull(svcId)) svcId = "gfnCallComDocTypePopup";
	
	if(gfnIsNull(callback)){
		gfnAlert("EPRO_LABEL_00918");
		return;
	}
	...
	gfnModalPop(obj, svcId, "SAMPLE::CSamplePop3.xfdl", sArg, callback, 500, 500);	
}
...
gfnSearchComMtrl = function(obj, svcId, callBack, arg , multiYn)
{
	...
	if(gfnIsNull(this._fvPopArg.agv_nm)){
		...
		if(this._fvMulti == 'Y'){
			gfnModalPop(this._fvObj, this._fvPopSvcId, "CPOP::BMtrlSrchMultiPopup.xfdl", sArg, "fnPopCallBack", 1100, 800);
			
		} else{
			gfnModalPop(this._fvObj, this._fvPopSvcId, "CPOP::BMtrlSrchPopup.xfdl", sArg, "fnPopCallBack", 1100, 500);
		}
		...
		dsSrchOpt.addColumn("ALT_USE", "string");
		...
		dsSrchOpt.setColumn(0,"ALT_USE", "Y");
...
gfnSearchComPtnr = function(obj, svcId, callBack, arg)
{
	...
	if(gfnIsNull(this._fvPopArg.agv_nm)){
		...
		gfnModalPop(this._fvObj, this._fvPopSvcId, "CPOP::BPtnrSrchPopup.xfdl", sArg, "fnPopCallBack", 900, 500);
		...
		dsSrchOpt.addColumn("BIZ_NO", "string");
		dsSrchOpt.addColumn("PTNR_NM", "string");
		dsSrchOpt.addColumn("ALT_USE", "string");
		dsSrchOpt.addColumn("BRANCH_CD", "string");
		
		dsSrchOpt.addRow();
		dsSrchOpt.setColumn(0,"BIZ_NO",this._fvPopArg.agv_nm);
...
gfnSearchComSl = function(obj, svcId, callBack, arg)
{
	...
	if(gfnIsNull(this._fvPopArg.agv_nm)){
		...
		gfnModalPop(this._fvObj, this._fvPopSvcId, "CPOP::BSlSrchPopup.xfdl", sArg, "fnPopCallBack", 700, 500);
...
gfnSearchComUser = function(obj, svcId, callBack, arg)
{
	...
	if(gfnIsNull(this._fvPopArg.agv_nm)){
		...
		gfnModalPop(this._fvObj, this._fvPopSvcId, "CPOP::BUserSrchPopup.xfdl", sArg, "fnPopCallBack", 900, 500);
		...
		dsSrchOpt.addColumn("DEPT_CD", "string");
		dsSrchOpt.addColumn("ALT_USE", "string");
		dsSrchOpt.addColumn("BRANCH_CD", "string");
		...
		dsSrchOpt.setColumn(0,"DEPT_CD",this._fvPopArg.agv_dept);
		dsSrchOpt.setColumn(0,"ALT_USE","Y");
		dsSrchOpt.setColumn(0,"BRANCH_CD", application.gdsUserInfo.getColumn(0,"BRANCH_CD"));
