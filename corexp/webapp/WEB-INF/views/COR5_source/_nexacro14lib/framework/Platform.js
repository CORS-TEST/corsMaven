...
if (!nexacro._bInitPlatform) {
	...
	_pWindow._on_default_sys_lbuttonup = function (elem, strButton, altKey, ctrlKey, shiftKey, windowX, windowY, screenX, screenY) {
		...
		if (elem && dragInfo && dragInfo.isDragging && dragInfo.targetwin == this) {
			...
			if (nexacro.OS == "Windows" && nexacro.Browser == "Edge") {
						...
						if (hover_comp && hover_comp[0]) {
							...
							if (touched_comp && touched_comp[0] && (comp[0] != hover_comp[0]) && (hover_comp[0] != touched_comp[0])) {
								if (touched_elem && touched_elem._handle) {
									...
									touched_comp[0]._on_dragleave(touched_elem, hover_comp[0], dragInfo.target, dragInfo.referTarget, dragInfo.data, dragInfo.userdata, strButton, altKey, ctrlKey, shiftKey, canvasX, canvasY, screenX, screenY);
								}
								...
								if (hover_elem && hover_elem._handle) {
									...
									hover_comp[0]._on_dragenter(hover_elem, touched_comp[0], dragInfo.target, dragInfo.referTarget, dragInfo.data, dragInfo.userdata, strButton, altKey, ctrlKey, shiftKey, canvasX, canvasY, screenX, screenY);
								}
							}
							else {
								...
								hover_comp[0]._on_dragmove(hover_elem, dragInfo.target, dragInfo.referTarget, dragInfo.data, dragInfo.userdata, strButton, altKey, ctrlKey, shiftKey, canvasX, canvasY, screenX, screenY, undefined, undefined, undefined, xdeltavalue, ydeltavalue);
							}
