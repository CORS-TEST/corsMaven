...
if (!nexacro.Frame) {
	...
	_pChildFrame._isFocusAcceptable = function () {
		if (this.visible && this.enable && ((this.width > 0 && this.height > 0) || (this._adjust_width > 0 && this._adjust_height) || (this._client_width > 0 && this._client_height > 0))) {
			return true;
		}
	...
	_pFrameSetBase._isFocusAcceptable = function () {
		if (this.visible && this.enable && ((this.width > 0 && this.height > 0) || (this._adjust_width > 0 && this._adjust_height))) {
			return true;
		}
