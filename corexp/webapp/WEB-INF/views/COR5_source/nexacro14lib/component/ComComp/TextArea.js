...
if (!nexacro.TextArea) {
	...
	_pTextArea.on_apply_custom_setfocus = function (evt_name) {
		...
		if (input_elem) {
			...
			else if (nexacro.Browser != "Edge" && !this.autoselect) {
	...
	_pTextArea._on_mousewheel = function (elem, wheelDeltaX, wheelDeltaY, button, alt_key, ctrl_key, shift_key, canvasX, canvasY, screenX, screenY, event_bubbles, fire_comp, refer_comp, bScroll) {
